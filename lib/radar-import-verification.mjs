export const RADAR_IMPORT_VERIFICATION_VERSION = 'radar_import_verification_v1';
...
export function verificationDatabaseConfig(environment = process.env) {
  ...
  if (!connectionString && !environment.PGHOST) return null;
  ...
  return {
    ...(connectionString ? { connectionString: connectionStringWithoutOptions(connectionString) } : {}),
    ssl,
